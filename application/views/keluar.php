...
<section class="section">
    <div class="card">
        <div class="card-body">
            <button class="btn btn-primary " onclick="window.location='<?= base_url('keluar/add') ?>'"><i class="bi bi-clipboard-heart-fill"></i> Tambah Data</button>
                ...
                <tbody>
                    ...
                    foreach ($keluar as $r) { ?>
                        <tr>
                            ...
                            <td><?= $r->penerima; ?></td>
                            <td>
                                <a href="<?= base_url('keluar/edit/' . $r->id_keluar) ?>"><i class="bi bi-pencil-square text-warning"></i></a> |
                                <a href="<?= base_url('keluar/delBayar/' . $r->id_keluar) ?>" class="tombol-hapus"><i class="bi bi-trash text-danger"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
