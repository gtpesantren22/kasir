    ...
    <div id="auth">
        ...
        <div class="row h-10">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <!-- <div class="auth-logo">
                        <a href="#"><img src="<?= base_url('template/') ?>assets/compiled/svg/logo.svg" alt="Logo"></a>
                    </div> -->
                    <h3 class="auth-title">Kasirt</h3>
                    <p class="auth-subtitle mb-5">Halaman login</p>
