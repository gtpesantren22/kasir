...
<section class="section">
    <div class="card">
        <div class="card-body">
            <?= form_open('setor/saveEdit') ?>
            <input type="hidden" name="id" value="<?= $data->id_setor ?>">
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select class="form-select choices" id="" required name="lembaga">
                        ...
                        <?php foreach ($lembaga as $ar) : ?>
                            <option <?= $data->lembaga == $ar->nama ? 'selected' : '' ?> value="<?= $ar->nama ?>"><?= $ar->nama ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1" class="form-label">Uraian</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" required name="uraian"><?= $data->uraian ?></textarea>
                </div>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" id="" name="tgl" class="form-control flatpickr-no-config" id="" placeholder="Tanggal" required value="<?= $data->tgl_setor ?>">
                </div>
                <div class="form-group mb-2">
                    <label for="">Penyetor</label>
                    <input type="text" id="" name="penyetor" class="form-control" id="" placeholder="Nama Penyetor" required value="<?= $data->penyetor ?>">
                </div>
            </div>
