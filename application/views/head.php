...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('template/') ?>assets/extensions/flatpickr/flatpickr.min.css">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <!-- <a href="<?= base_url('home') ?>"><img src="<?= base_url('template/') ?>assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a> -->
                            <i class="bi bi-activity"></i> KSR
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <div class="divider">
                            <div class="divider-text">Pemasukan</div>
                        </div>
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="<?= base_url('bp/bayar') ?>" class="submenu-link">Pembayaran</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?= base_url('setor') ?>" class='sidebar-link'>
